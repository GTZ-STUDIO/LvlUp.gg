  ...
  return (
    <div className='signup'>    
      ...
      <div className='signup-form'>
        ...
        <input type="text" id="firstname" name="firstname" value={firstname} onChange={e => setFirstName(e.target.value)} className='signin-input'/>
      </div>
      <div className='signup-form'>
        <label htmlFor="lastname">Last:</label>
        <input type="text" id="lastname" name="lastname" value={lastname} onChange={e => setLastName(e.target.value)} className='signin-input'/>
      </div>
